...
class TransaksiService {
    ...
    mapMidtransStatus(midtransStatus) {
        const statusMapping = {
            'capture': 'success', 'settlement': 'success', 'success': 'success',
            'pending': 'pending', 'deny': 'failed', 'cancel': 'cancelled',
            'expire': 'expired', 'failed': 'failed', 'refund': 'refunded',
            'partial_refund': 'partial_refund', 'chargeback': 'chargeback'
        };
